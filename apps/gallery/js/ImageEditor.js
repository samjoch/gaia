...
ImageEditor.prototype.drawCropControls = function(handle) {
  ...
  var nHandle = new Image();
  nHandle.src = '../style/images/crop_line.png';
  nHandle.onload = function() {
    console.log('Load N handle', nHandle);
    var nPat = context.createPattern(nHandle, 'repeat-x');
    context.rect(centerX - 23, top - 1, 46, 4);
    context.fillStyle = nPat;
    context.fill();
  };
  console.log('After init Pattern');
